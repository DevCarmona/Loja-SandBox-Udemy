                    ...
                    <?php endif;?> -->
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label>Razão social</label> <!-- set_value = Mantem o q foi preenchido  -->
                            ...
                            <div class="form-group col-md-3">
                                <label>Nome fantasia</label> <!-- set_value = Mantem o q foi preenchido  -->
                            ...
                            <div class="form-group col-md-3">
                                <label>CNPJ</label> <!-- set_value = Mantem o q foi preenchido  -->
                            ...
                            <div class="form-group col-md-3">
                                <label>Inscrição estadual</label> <!-- set_value = Mantem o q foi preenchido  -->
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label>Telefone fixo</label> <!-- set_value = Mantem o q foi preenchido  -->
                            ...
                            <div class="form-group col-md-3">
                                <label>Telefone móvel</label> <!-- set_value = Mantem o q foi preenchido  -->
                            ...
                            <div class="form-group col-md-3">
                                <label>E-mail de contato</label> <!-- set_value = Mantem o q foi preenchido  -->
                            ...
                            <div class="form-group col-md-3">
                                <label>URL do site</label> <!-- set_value = Mantem o q foi preenchido  -->
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                <label>CEP</label> <!-- set_value = Mantem o q foi preenchido  -->
                            ...
                            <div class="form-group col-md-4">
                                <label>Endereço</label> <!-- set_value = Mantem o q foi preenchido  -->
                            ...
                            <div class="form-group col-md-2">
                                <label>Número</label> <!-- set_value = Mantem o q foi preenchido  -->
                            ...
                            <div class="form-group col-md-2">
                                <label>Cidade</label> <!-- set_value = Mantem o q foi preenchido  -->
                            ...
                            <div class="form-group col-md-2">
                                <label>UF</label> <!-- set_value = Mantem o q foi preenchido  -->
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                <label>Quantidade de produto em destaque</label> <!-- set_value = Mantem o q foi preenchido  -->
